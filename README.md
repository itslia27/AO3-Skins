...
You can adjust the glow effect by changing the last value here (line ---):
...
You can also customize the glow used throughout the skin! This can be changed in lines --- by increasing/reducing the last value in the line.
...
To increase contrast, you can edit their colour value in the TAGS section (line ---):
